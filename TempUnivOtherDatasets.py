...
#plt.legend(loc='upper right', frameon=legend_drawn_flag)
plt.savefig("Beijintotal.png", figsize=(10,5))
plt.show()
...
# Finding the RMSE and MAPE (Error metrics)
trainScore = math.sqrt(mean_squared_error(trainY[0], trainPredict[:, 0]))
print('Train Score: %.2f RMSE' % (trainScore))
testScore = math.sqrt(mean_squared_error(testY[0], testPredict[:, 0]))
print('Test Score: %.2f RMSE' % (testScore))
testMape = mean_absolute_percentage_error(trainY[0], trainPredict[:, 0])
